					...
					if (GetFunction(ref Function, c)){
						...
						switch ((int)Function){
							...
							case (int)eFunction.yAR:{
								int Slot = 0;
								int Value = 0;
								if (c.GetDecimal(ref Slot, false)){
									if (c.GetValue(ref Value, true)){
										if (Slot >= 1 && Slot <= 2 && Value >= 0 && Value <= 31){
											var yAR = (Slot == 1)? Packet.eCommand.yAR1: Packet.eCommand.yAR2;
							...
							case (int)eFunction.yDR:{
								...
								if (c.GetDecimal(ref Slot, false)){
									if (c.GetValue(ref Value, true)){
										if (Slot >= 1 && Slot <= 2 && Value >= 0 && Value <= 31){
											var yDR = (Slot == 1)? Packet.eCommand.yDR1: Packet.eCommand.yDR2;
							...
							case (int)eFunction.ySR:{
								...
								if (c.GetDecimal(ref Slot, false)){
									if (c.GetValue(ref Value, true)){
										if (Slot >= 1 && Slot <= 2 && Value >= 0 && Value <= 31){
											var ySR = (Slot == 1)? Packet.eCommand.ySR1: Packet.eCommand.ySR2;
							...
							case (int)eFunction.yRR:{
								...
								if (c.GetDecimal(ref Slot, false)){
									if (c.GetValue(ref Value, true)){
										if (Slot >= 1 && Slot <= 2 && Value >= 0 && Value <= 15){
											var yRR = (Slot == 1)? Packet.eCommand.yRR1: Packet.eCommand.yRR2;
							...
							case (int)eFunction.ySL:{
								...
								if (c.GetDecimal(ref Slot, false)){
									if (c.GetValue(ref Value, true)){
										if (Slot >= 1 && Slot <= 2 && Value >= 0 && Value <= 15){
											var ySL = (Slot == 1)? Packet.eCommand.ySL1: Packet.eCommand.ySL2;
							...
							case (int)eFunction.yTL:{
								...
								if (c.GetDecimal(ref Slot, false)){
									if (c.GetValue(ref Value, true)){
										if (Slot >= 1 && Slot <= 2 && Value >= 0 && Value <= 127){
											var yTL = (Slot == 1)? Packet.eCommand.yTL1: Packet.eCommand.yTL2;
							...
							case (int)eFunction.yKS:{
								...
								if (c.GetDecimal(ref Slot, false)){
									if (c.GetValue(ref Value, true)){
										if (Slot >= 1 && Slot <= 2 && Value >= 0 && Value <= 3){
											var yKS = (Slot == 1)? Packet.eCommand.yKS1: Packet.eCommand.yKS2;
							...
							case (int)eFunction.ySE:{
								...
								if (c.GetDecimal(ref Slot, false)){
									if (c.GetValue(ref Value, true)){
										if (Slot >= 1 && Slot <= 2 && Value >= 0 && Value <= 15){
											var ySE = (Slot == 1)? Packet.eCommand.ySE1: Packet.eCommand.ySE2;
